...
const homeCopy = {
  en: {
    ...
    h1: "Flipkart label cropper, Meesho label maker, Amazon Easy Ship fee calculator, picklists, GST helper, and seller analytics",
    intro:
      "Browser-based tools for Flipkart label cropping, Meesho 4-up and 6-up A4 label PDFs, Amazon Easy Ship shipping fee calculation, volumetric weight checks, sorted label PDF downloads, courier and SKU label sorting, picklist generation, ecommerce performance analytics, GST analysis, and marketplace report preparation.",
    ...
    features: [
      ...
      ["Amazon Easy Ship fee calculator", "Estimate chargeable weight, volumetric weight, Easy Ship fee, GST, and shipping buffer before pricing Amazon India products."],
    ...
    searchText:
      "These pages target high-intent seller searches such as Flipkart label crop, Meesho label 4 in 1, Meesho 6 labels per page, Amazon Easy Ship fee calculator, Amazon volumetric weight calculator, sorted label PDF download, courier wise label sorting, SKU wise label sorting, ecommerce picklist generator, seller shipping label PDF, GSTR-1 helper, ecommerce seller insights tools, performance analytics, and marketplace data analysis.",
    links: [
      ...
      ["Amazon Easy Ship Fee Calculator", "Calculate actual vs volumetric chargeable weight, GST-inclusive Easy Ship shipping fee, and product pricing buffer for Amazon India sellers."],
  ...
  hi: {
    ...
    h1: "फ्लिपकार्ट label cropper, मीशो label maker, Amazon Easy Ship fee calculator, picklists, GST helper और seller analytics",
    intro:
      "Browser-based tools जिससे फ्लिपकार्ट label crop, मीशो 4-up और 6-up A4 label PDFs, Amazon Easy Ship shipping fee calculation, volumetric weight checks, sorted label PDF downloads, courier और SKU label sorting, picklist generation, ecommerce performance analytics, GST analysis और marketplace report preparation easy होता है.",
    ...
    features: [
      ...
      ["Amazon Easy Ship fee calculator", "Amazon India products की pricing से पहले chargeable weight, volumetric weight, Easy Ship fee, GST और shipping buffer estimate करो."],
    ...
    searchTitle: "Popular marketplace seller workflows",
    searchText:
      "ये pages high-intent seller searches के लिए हैं जैसे फ्लिपकार्ट label crop, मीशो label 4 in 1, मीशो 6 labels per page, Amazon Easy Ship fee calculator, Amazon volumetric weight calculator, sorted label PDF download, courier wise label sorting, SKU wise label sorting, ecommerce picklist generator, seller shipping label PDF, GSTR-1 helper, ecommerce seller insights tools, performance analytics और marketplace data analysis.",
    links: [
      ...
      ["Amazon Easy Ship Fee Calculator", "Amazon India sellers के लिए actual vs volumetric chargeable weight, GST-inclusive Easy Ship shipping fee और pricing buffer calculate करो."],
