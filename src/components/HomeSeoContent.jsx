...
const homeCopy = {
  en: {
    ...
    h1: "Flipkart label cropper, Meesho label maker, Amazon fee and listing price calculator, GST helper, and seller analytics",
    intro:
      "Browser-based tools for Flipkart label cropping, Meesho 4-up and 6-up A4 label PDFs, Amazon Easy Ship shipping fee calculation, Amazon listing price and profit estimates, volumetric weight checks, sorted label PDF downloads, courier and SKU label sorting, picklist generation, ecommerce performance analytics, GST analysis, and marketplace report preparation.",
    ...
    features: [
      ...
      ["Amazon fee and listing price calculator", "Estimate Easy Ship fee, volumetric weight, referral fee, closing fee, GST on fees, break-even price, profit, and margin before listing Amazon India products."],
    ...
    searchText:
      "These pages target high-intent seller searches such as Flipkart label crop, Meesho label 4 in 1, Meesho 6 labels per page, Amazon Easy Ship fee calculator, Amazon listing price calculator, Amazon referral fee calculator, Amazon closing fee calculator, Amazon volumetric weight calculator, sorted label PDF download, courier wise label sorting, SKU wise label sorting, ecommerce picklist generator, seller shipping label PDF, GSTR-1 helper, ecommerce seller insights tools, performance analytics, and marketplace data analysis.",
    links: [
      ...
      ["Amazon Fee and Listing Price Calculator", "Calculate actual vs volumetric chargeable weight, GST-inclusive Easy Ship fee, referral fee, closing fee, profit margin, and break-even selling price for Amazon India sellers."],
  ...
  hi: {
    ...
    h1: "फ्लिपकार्ट label cropper, मीशो label maker, Amazon fee और listing price calculator, GST helper और seller analytics",
    intro:
      "Browser-based tools जिससे फ्लिपकार्ट label crop, मीशो 4-up और 6-up A4 label PDFs, Amazon Easy Ship shipping fee calculation, Amazon listing price और profit estimates, volumetric weight checks, sorted label PDF downloads, courier और SKU label sorting, picklist generation, ecommerce performance analytics, GST analysis और marketplace report preparation easy होता है.",
    ...
    features: [
      ...
      ["Amazon fee और listing price calculator", "Amazon India products list करने से पहले Easy Ship fee, volumetric weight, referral fee, closing fee, GST on fees, break-even price, profit और margin estimate करो."],
    ...
    searchTitle: "Popular marketplace seller workflows",
    searchText:
      "ये pages high-intent seller searches के लिए हैं जैसे फ्लिपकार्ट label crop, मीशो label 4 in 1, मीशो 6 labels per page, Amazon Easy Ship fee calculator, Amazon listing price calculator, Amazon referral fee calculator, Amazon closing fee calculator, Amazon volumetric weight calculator, sorted label PDF download, courier wise label sorting, SKU wise label sorting, ecommerce picklist generator, seller shipping label PDF, GSTR-1 helper, ecommerce seller insights tools, performance analytics और marketplace data analysis.",
    links: [
      ...
      ["Amazon Fee और Listing Price Calculator", "Amazon India sellers के लिए actual vs volumetric chargeable weight, GST-inclusive Easy Ship fee, referral fee, closing fee, profit margin और break-even selling price calculate करो."],
