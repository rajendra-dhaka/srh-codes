...
export const gstCopy = {
  en: {
    kicker: "GST Analysis",
    title: "Free GST filing workspace for ecommerce sellers",
    intro: "Pick your return month, upload marketplace reports, then follow the portal table map without paying a monthly accountant just to copy values.",
    freeHelperKicker: "Built for new sellers",
    heroTitle: "File GSTR-1 with confidence, even when profits are still zero.",
    heroBody: "This workspace tells you which marketplace files to download, checks whether required files are ready, and maps the numbers to GST Portal tables.",
    periodTitle: "Return month",
    periodHelp: "Choose the month and financial year before collecting marketplace reports.",
    platformTitle: "Sales marketplaces",
    platformHelp: "Select where sales happened this month. At least one marketplace is required.",
    docsTitle: "Collect marketplace files",
    docsHelp: "Each selected marketplace gets its own upload card. The workspace reads Meesho, Flipkart and Amazon filing reports, then combines them into portal-ready GSTR-1 tables.",
    ...
    manualOnlyTitle: "Manual checklist mode",
    manualOnlyBody: "Upload all required files so this workspace can prepare the selected marketplace values.",
    manualWorkspaceReady: "All selected marketplace files are ready. Generate the workspace to review portal-ready values.",
    ...
    generate: "Generate filing workspace",
    analyzing: "Analyzing...",
    required: "required",
    stepOne: "Step 1",
    requiredForGstr1: "Required for GSTR-1",
    optionalBackup: "Optional backup",
    marketReady: "Required files ready",
    marketPending: (count) => `${count} required pending`,
    readyToGenerate: "Ready",
    notReadyYet: "Not ready yet",
    allRequiredReady: "All required files for selected marketplaces are uploaded.",
    requiredPending: (count) => `${count} required file${count === 1 ? "" : "s"} pending before the filing workspace can be generated.`,
  ...
  hi: {
    ...
    title: "Ecommerce sellers के लिए free GST filing workspace",
    intro: "Return month चुनो, marketplace reports upload करो, फिर portal table map follow करके values भरो.",
    freeHelperKicker: "New sellers के लिए",
    heroTitle: "Profit zero हो तब भी GSTR-1 confidence से file करो.",
    heroBody: "यह workspace बताता है कौनसी marketplace files download करनी हैं, required files ready हैं या नहीं, और GST Portal tables में numbers कहां भरने हैं.",
    periodTitle: "Return month",
    periodHelp: "Marketplace reports collect करने से पहले month और financial year select करो.",
    platformTitle: "Sales marketplaces",
    platformHelp: "इस month जहां sales हुई हैं वही marketplaces select करो. कम से कम एक जरूरी है.",
    docsTitle: "Marketplace files collect करो",
    docsHelp: "हर selected marketplace का अपना upload card मिलेगा. Workspace Meesho, Flipkart और Amazon filing reports read करके portal-ready GSTR-1 tables combine करेगा.",
    homeStateLabel: "Seller home GST state",
    ...
    manualOnlyTitle: "Manual checklist mode",
    manualOnlyBody: "सभी required files upload करो ताकि workspace selected marketplace values prepare कर सके.",
    manualWorkspaceReady: "Selected marketplaces की सभी required files ready हैं. Portal-ready values review करने के लिए workspace generate करो.",
    ...
    generate: "Filing workspace generate करो",
    analyzing: "Analyze हो रहा है...",
    required: "जरूरी",
    stepOne: "Step 1",
    requiredForGstr1: "GSTR-1 के लिए जरूरी",
    optionalBackup: "Optional backup",
    marketReady: "Required files ready",
    marketPending: (count) => `${count} required pending`,
    readyToGenerate: "Ready",
    notReadyYet: "अभी ready नहीं",
    allRequiredReady: "Selected marketplaces की सभी required files upload हो गई हैं.",
    requiredPending: (count) => `Filing workspace generate करने से पहले ${count} required file${count === 1 ? "" : "s"} pending हैं.`,
