    ...
    copy: {
      ...
      hi: {
        ...
        sections: [
          ...
          { title: "4-up, 6-up या 9-up चुनो", paragraphs: ["Readable text और बड़े barcode के लिए 4 labels per A4 चुनो. Balanced paper saving के लिए 6 labels, या compact output के लिए 9 labels चुन सकते हो, लेकिन पहले barcode scan test जरूर करो.", "Print dialog में unnecessary Fit to page scaling avoid करो."] },
